...
async def cmd_start(m: types.Message, state: FSMContext):
    ...
    await m.answer(
        ...
        "Нажмите кнопку ниже, чтобы начать. Нажимая на кнопку вы соглашаетесь с <a href='https://docs.google.com/document/d/1X7tkZC7Hkb9s4AZ6kMFSsqzpLVSmD-mG/edit?usp=sharing&ouid=117311354454919797859&rtpof=true&sd=true'>Положением об обработке персональных данных.</a>",
